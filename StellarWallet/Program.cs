...
namespace StellarWallet
{
    class Program
    {
        private const string NetworkPassphrase = "Test Newton Network ; 2018-02-27";
        public static string seed = "SDGGEW2VCBNYP5FQE2EKZU3NWZAKUF4GJA4SQ47LV7PA2VKAEYXZA7KJ";
        ...
        public static async Task Main(string[] args)
        {
            ...
            var destID = "GCKVX5H5XVVDE653PU7SWDDZEAMBHRY6ECTDVLRCFFHNP33R2JOLRPXC";
            //await CreateAccount(KeyPair.FromAccountId(destID));
